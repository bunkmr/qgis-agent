...
class Processor(QObject):
    ...
    def __init__(self, llm_id, conversation_id, dataloader):
        ...
        self.llm = get_llm_instance(self.provider, model_name, api_key, endpoint, temperature=0)
        self.streaming_llm = get_llm_instance(self.provider, model_name, api_key, endpoint, temperature=0)
